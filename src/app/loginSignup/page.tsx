...
import { apiRegister } from '../api/app';
          ...
          <div className={styles.loginForm}>
            ...
            <div className="w-full flex flex-col justify-between items-center py-4 gap-3 h-64">
              ...
              <div className={error ? styles.loginFieldErr : styles.loginField}>
                ...
                {passwordError && (
                  <p className="my-1 text-xs">{passwordError}</p>
                )}
              </div>
              <div>
                <button
                  className="mt-6 font-bold text-white text-xs bg-blue-500 py-3 px-6 disabled:shadow-none rounded-lg hover:shadow-blue-500/40 hover:shadow-lg hover:shadow-relative"
                  onClick={login}
                >
                  SE CONNECTER
                </button>
        ...
        {!isLogin ? (
          <div className={styles.signupForm}>
            ...
            <div className="w-full flex flex-col justify-between items-center py-4 mt-4 h-68 gap-3">
              ...
              <button
                className="mt-8 font-bold text-white text-xs bg-blue-500 py-3 px-5 disabled:shadow-none rounded-lg hover:shadow-blue-500/40 hover:shadow-lg hover:shadow-relative"
                onClick={signUp}
              >
                S'INSCRIRE
              </button>
