        ...
        <div className={styles.homeContent}>
          <div>
            ...
            <div className={styles.startButton}>
              <button className='capitalize h-16 w-56 bg-blue-500 text-white font-bold rounded-lg disabled:shadow-none hover:shadow-blue-500/40 hover:shadow-lg hover:shadow-relative'><Link href='/loginSignup' className='w-full text-xl'>Se connecter</Link></button>
            </div>
          </div>
          <div>
            <Image
