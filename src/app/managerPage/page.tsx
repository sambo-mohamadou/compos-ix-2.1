      ...
      <div className='w-full h-full flex justify-start items-start pt-4 pl-1 overflow-hidden relative'>
        ...
        <div className='absolute w-full h-full z-50' style={{background: 'rgba(3, 3, 3, 0.4)'}}>
            <div className=' flex justify-center items-center w-full h-full relative'>
                <div className='w-96 min-h-52 bg-white rounded-lg'>
                    ...
                    <div className='p-2'>
                        ...
                        <Link href='/managerPage' className='px-10 text-white py-2 rounded-md bg-orange-400 hover:bg-orange-500'> Entrez </Link>
                        </div>
                    </div>
                </div>
