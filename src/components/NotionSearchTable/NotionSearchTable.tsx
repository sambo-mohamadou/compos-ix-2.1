...
import SearchTableEntry from './SearchTableEntry'


const NotionSearchTable = (documents : {documentName : string, notionsList : {content : string}[]}[]) => {
  
    const notionFinderObject: {documentName : string, notionsList : {content : string}[]}[] = [
        {
        ...
        return (
    <section className='w-[600px] h-full border-2 rounded-lg p-2 flex flex-col justify-between overflow-hidden'>
...
export default NotionSearchTable
